...
export default function WifiWhitelist() {
  ...
  useMount(() => run({ type: 1, page: 1, limit: 10 }));
  return (
    <>
      <AddWifiWhitelistItem onSubmitted={refresh} />
      <Table
        loading={loading}
...
function AddWifiWhitelistItem({ onSubmitted }: { onSubmitted: () => void }) {
